...
urlpatterns = [
    ...
    path('repair/<int:repair_id>/', phs_views.RepairView.as_view(), name='repair'),
    ...
    path('update_event', phs_views.CalendarUpdateEventView.as_view(), name='update_event'),
    path('remove_event', phs_views.CalendarRemoveEventView.as_view(), name='remove_event'),
]
